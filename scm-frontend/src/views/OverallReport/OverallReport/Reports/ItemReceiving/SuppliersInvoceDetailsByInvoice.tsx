...
const SupplierInvoiceDetailsByInvoice: React.FC = () => {
  // --- Dark mode ---
    ...
    try {
      ...
      if (result.success) {
        ...
        if (apiSuppliers && apiSuppliers.length > 0) {
          ...
          showToast('No suppliers available for the selected period', 'error');
  ...
  const generateFileName = (): string => {
    ...
    let fileName = `SupplierInvoiceDetailsByInvoiceReport_${periodStr}`;
  ...
  const buildRequestBody = () => {
    ...
    if (selectedInvoiceId && selectedInvoiceId.trim() !== '') {
      body.invoiceNo = selectedInvoiceId;
    }
  ...
  const handleDownload = async () => {
    ...
    try {
      const res = await fetch(
        'http://43.254.31.234:9070/api-gateway-scm/reports-service-scm/pythonReportController/supplierInvoiceDetailsByInvoiceReport',
        {
          method: 'POST',
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  return (
    <div className="max-h-screen w-full bg-gray-50 dark:bg-gray-900 flex flex-col transition-all duration-300 p-2 sm:p-4">
        ...
        <div className="fixed inset-0 bg-transparent backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-xl p-6 w-full max-w-md mx-auto">
            ...
            <p className="text-gray-600 dark:text-gray-400 mb-6">
              Do you want to download the Supplier Invoice Details By Invoice Report for the selected criteria?
            </p>
      ...
      {/* Header (unchanged) */}
      <CommonHeader
        title="Supplier Invoice Details By Invoice"
      ...
      <div className="bg-white dark:bg-gray-800 p-2 sm:p-4 md:p-6 lg:p-8 rounded-2xl shadow-md w-full max-w-6xl mx-auto">
        <LocalizationProvider dateAdapter={AdapterDayjs}>
          <div className="space-y-4 sm:space-y-6">
            ...
            {/* Row 2: Invoice No, From Date, To Date – FIXED DatePickers */}
            <div className="flex flex-col lg:flex-row gap-3 sm:gap-4">
              ...
              {/* --- FIXED: From Date (with red asterisk) --- */}
              ...
              {/* --- FIXED: To Date (with red asterisk) --- */}
              <div className="flex-1">
                <DatePicker
...
export default SupplierInvoiceDetailsByInvoice;