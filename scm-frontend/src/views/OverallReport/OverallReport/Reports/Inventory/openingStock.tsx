...
const OpeningStock: React.FC = () => {
  ...
  const downloadFile = async () => {
    ...
    try {
      ...
      const apiUrl = `http://43.254.31.234:9070/api-gateway-scm/reports-service-scm/scmReportsController/listOfTheoreticalData/${formattedDate}/${userId}`;
      ...
      let filename = `Opening stock report-${formattedDate}${fileExtension}`;
         ...
         items-center justify-center z-40 p-4">
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-xl p-6 w-full max-w-md mx-auto">
            ...
            <p className="text-gray-600 dark:text-gray-400 mb-6">
              Are you sure you want to download the opening stock report for{' '}
      ...
      disabled:opacity-50 disabled:cursor-not-allowed"
        ...
        <div className="mt-8 text-center md:hidden">
          <p className="text-sm text-gray-500 dark:text-gray-400">
            Tap on the period to select a different month and year
          </p>
        </div>
      </div>
