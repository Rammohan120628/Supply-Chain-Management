...
const SavingsSummaryByLocation: React.FC = () => {
  ...
  const downloadFile = async () => {
    ...
    try {
      ...
      const apiUrl = `http://43.254.31.234:9070/api-gateway-scm/reports-service-scm/scmReportsController/listOfsavingsSummaryByLocReport/${formattedDate}/${userId}`;
      ...
      let filename = `Savings summary by location report-${formattedDate}${fileExtension}`;
  ...
  return (
    ...
    flex flex-col p-4 transition-all duration-300">
         ...
         items-center justify-center z-40 p-4">
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-xl p-6 w-full max-w-md mx-auto">
            ...
            <p className="text-gray-600 dark:text-gray-400 mb-6">
              Are you sure you want to download the savings summary bu location report for{' '}
      ...
      {/* Header */}
       ...
       <CommonHeader
            title="Savings Summary By Location Report"
      ...
      <div className="bg-white dark:bg-gray-800 p-2 md:p-6 rounded-2xl shadow-md w-full max-w-5xl mx-auto flex-1">
        ...
        <div className="flex justify-center gap-4 md:gap-6">
         <Tooltip content='Download'> <button
            ...
            disabled={loading}
            className={`bg-blue-700 dark:bg-blue-800 hover:bg-blue-600 dark:hover:bg-blue-700 text-white text-xl p-3 rounded-full
          ...
          <Tooltip content='Clear'><button
            ...
            disabled={loading}
            className="bg-red-600 dark:bg-red-700 hover:bg-red-700 dark:hover:bg-red-600 text-white text-xl p-3 rounded-full 
              shadow-lg transition-all duration-300 flex items-center justify-center
              hover:shadow-xl transform hover:scale-105 active:scale-95
...
export default SavingsSummaryByLocation;