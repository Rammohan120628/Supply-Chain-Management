...
const CashAccountSummary: React.FC = () => {
  ...
  const handleClearAll = () => {
    setSelectedMonth(10); // Updated to default to November
  ...
  const downloadFile = async () => {
    ...
    try {
      ...
      const apiUrl = `http://43.254.31.234:9070/api-gateway-scm/reports-service-scm/scmReportsController/ocdListReport/${formattedDate}/${userId}`;
      ...
      let filename = `CashAccountSummary-${formattedDate}${fileExtension}`;
  ...
  return (
    <div className="max-h-screen w-full bg-gray-50 dark:bg-gray-900 flex flex-col p-4 transition-all duration-300">
         ...
         items-center justify-center z-40 p-4">
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-xl p-6 w-full max-w-md mx-auto">
            ...
            <p className="text-gray-600 dark:text-gray-400 mb-6">
              Are you sure you want to download the cash summary account report for{' '}
            ...
            <div className="flex flex-col sm:flex-row justify-end gap-3">
              <button
                ...
                className="px-4 py-2 text-gray-600 dark:text-gray-300 border border-gray-300 dark:border-gray-600 rounded-md hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors flex-1 sm:flex-none"
              >
                Cancel
              </button>
              <button
                ...
                disabled={loading}
                className="px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors flex-1 sm:flex-none"
              >
                {loading ? (
      ...
      <CommonHeader
      title="Cash Account Summary Report"
      ...
      <div className="bg-white dark:bg-gray-800 p-2 md:p-6 rounded-2xl shadow-md w-full max-w-5xl mx-auto flex-1">
        ...
        <div className="flex justify-center gap-4 md:gap-6">
           <Tooltip content='Download'><button
            ...
            disabled={loading}
            className={`bg-blue-700 hover:bg-blue-600 text-white text-xl p-4 rounded-full
          ...
          <button
            ...
            disabled={loading}
            className="bg-red-600 hover:bg-red-700 text-white text-xl p-4 rounded-full 
              shadow-lg transition-all duration-300 flex items-center justify-center
              hover:shadow-xl transform hover:scale-105 active:scale-95
