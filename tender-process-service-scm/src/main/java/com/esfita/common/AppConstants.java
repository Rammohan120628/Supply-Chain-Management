...
public  class AppConstants {
	...
	public static final String FILE_GENERATED = "file generated successfully: {}";	
	public static final String GET_QTY = "getQty";
	public static final String ACTIVE = "Active";
	public static final String IN_ACTIVE = "In-Active";
	public static final String JSON = "Json File Path is - {}";	
	public static final String FILE = "File I/O error: {}";	 
	...
	public static final String POGENERATELIST = "poGenerateList";
	public static final String ERROR = "Error: ";
	public static final String PAYMENT= "Payment";
	public static final String RECEIPT="Receipt";
	public static final String SUPPLIER_NOT_FOUND = "Supplier not found for ID: ";
