...
public class TracingConfig {
	...
	public Tracer micrometerTracer() {
		...
		Attributes serviceAttrs = Attributes.of(AttributeKey.stringKey("service.name"), "tender-process-service-scm");
		...
		return new OtelTracer(openTelemetry.getTracer("tender-process-service-scm"), new OtelCurrentTraceContext(),
				(span) -> {
				});
	}
}
