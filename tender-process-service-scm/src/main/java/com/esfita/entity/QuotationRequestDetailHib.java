...
@Table(name = "req_detail", schema = "public")
public class QuotationRequestDetailHib implements Serializable {

    private static final long serialVersionUID = 6395688408363896352L;

    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    @Column(name = "REQ_DETAIL_PK1", updatable = false)
    private Integer reqDetailPk;

    @Column(name = "REQ_HEAD_FK1")
