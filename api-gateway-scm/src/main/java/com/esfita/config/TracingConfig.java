...
public class TracingConfig {
	...
	@Bean
	 Tracer micrometerTracer() {
		...
		Attributes serviceAttrs = Attributes.of(AttributeKey.stringKey("service.name"), "api-gateway-service-scm");
		...
		return new OtelTracer(openTelemetry.getTracer("api-gateway-service-scm"), new OtelCurrentTraceContext(),
				span -> {
				});
	}
}
